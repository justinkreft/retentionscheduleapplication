<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="stateretentionpolicies.aspx.cs" Inherits="RetentionSchedules.stateretentionpolicies" %>
...
<body>
    <div>
        <table>
            <tr>
                <td style="width: 850px" class="HeadText1"><b><asp:Label ID="PageTitle" runat="server" CssClass="HeadText1"></asp:Label></b></td>
    ...
    <table border="0">
            ...
            <tr>
                ...
                <td rowspan="9"  style="width: 500px; vertical-align: top;" >
                </td>
            </tr>
            <tr>
                <td class="HeadText2">
