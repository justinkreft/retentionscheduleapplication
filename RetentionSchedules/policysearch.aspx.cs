...
{
    public partial class policysearch : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                if (!IsPostBack)
                {
                    Title.Text = "Displaying All Wake County Policy Records";   
                }
            }
            //Construct Drop down lists
            if (!IsPostBack)
            {
                ddlQuery.SelectCommand = "SELECT DISTINCT PolicyGroupUID, PolicyGroupName FROM divisionlkup WHERE PolicyGroupUID != '' ORDER BY PolicyGroupName";
